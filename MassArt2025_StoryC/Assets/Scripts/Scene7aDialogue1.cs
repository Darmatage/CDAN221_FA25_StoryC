...
public class Scene7aDialogue 1 : MonoBehaviour {
...
//Players hit [NEXT] to progress to the next primeInt:
	public void Next(){
        ...
        if (primeInt == 1){
                ...
                Char1name.text = "YOU";
                Char1speech.text = "Do you want this? [Mary Jane]";
                Char2name.text = "";
                Char2speech.text = "";
        }
        else if (primeInt == 3){
                ...
                Char2speech.text = "Where did you get this?";
        }
        else if (primeInt == 4){
                ArtChar1a.SetActive(true);
                Char1name.text = "YOU";
                Char1speech.text = "Big kid gave to me.";
                Char2name.text = "";
                Char2speech.text = "";
 	 }
        else if (primeInt == 5){
