...
//Players hit [NEXT] to progress to the next primeInt:
	public void Next(){
        ...
        if (primeInt == 1){
                ...
                Char1name.text = "YOU";
                Char1speech.text = "I'm sooooo hungry";
                Char2name.text = "";
                Char2speech.text = "";
        }
        else if (primeInt == 3){
                ...
                Char2speech.text = "Ugh. Another one.";
        }
        else if (primeInt == 4){
                ArtChar1a.SetActive(true);
                Char1name.text = "";
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "What do you want, kid.";
...
//AFTER CHOICE 1a:
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "I don't need your life story";
        }
       else if (primeInt == 12){
                Char1name.text = "";
                Char1speech.text = "";
                ...
                //Char1speech.text = "Here you go! 3.99. I have " + GameHandler.moneyAmt + " left over.";
                Char2name.text = "";
                Char2speech.text = "";
        }
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "Here's your pizza, kid.";
                primeInt = 59;
                //update stat: 
                ...
                //Char1speech.text = "I don't have enough money. I only have " + GameHandler.moneyAmt + " dollars.";
                Char2name.text = "";
                Char2speech.text = "";
        }
...
// after choice 1b
                ...
                Char1name.text = "YOU";
                Char1speech.text = "Is your nephew amphibious?";
                Char2name.text = "";
                Char2speech.text = "";
        }
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "I don't know what you mean.";
        }

       else if (primeInt == 23){
                Char1name.text = "YOU";
                Char1speech.text = "I guess that's a 'no'";
                Char2name.text = "";
                Char2speech.text = "";
                // Turn off the "Next" button, turn on "Choice" buttons
                nextButton.SetActive(false);
...
//AFTER choice 2a: after "I hate your nephew"
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "Nice mouth! I like your style, kid.";
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "Want a lighter?";
        }
...
//AFTER choice 2b: after "Ido YOU liek sharks?
                ...
                Char1speech.text = "";
                Char2name.text = "Lunch Lady";
                Char2speech.text = "Get lost, kid. I don't have time for your aquarium.";
                ...
                ArtChar1d.SetActive(false);
                Char1name.text = "YOU";
                Char1speech.text = "Guess I'll go back to the hallway";
                Char2name.text = "";
                Char2speech.text = "";
