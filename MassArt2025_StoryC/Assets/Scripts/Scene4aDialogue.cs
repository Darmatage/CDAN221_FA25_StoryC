...
// For more character images / buttons, copy & renumber the variables:
        ...
        public GameObject ImageChar1c;
        public GameObject ImageChar1d;
...
// Set initial visibility. Added images or buttons need to also be SetActive(false);
        void Start(){  
             ...
             ImageChar1c.SetActive(false);
             ImageChar1d.SetActive(false);
...
public void Next(){
        primeInt += 1;
                ...
                {
                        Char1name.text = "YOU";
                        Char1speech.text = "Why are you holding your breath? Did sometghing spill in the sceience closet?";
                        Char2name.text = "";
                        Char2speech.text = "";
                        Char3name.text = "";
                        Char3speech.text = "";
                ...
                else if (primeInt == 41)
                {
                        ...
                        Char3speech.text = "Now what do you want to do?";
                        // Turn off the "Next" button, turn on "Choice" buttons
                        nextButton.SetActive(false);
                        allowSpace = false;
...
// FUNCTIONS FOR BUTTONS TO ACCESS (Choice #1 and SceneChanges)
        ...
        public void Choice2bFunct()
        {
                ...
                Char3name.text = "";
                Char3speech.text = "";
                primeInt = 40; // so hitting "NEXT" goes to primeInt==41!
                Choice2a.SetActive(false);
                Choice2b.SetActive(false);
                nextButton.SetActive(true);
                allowSpace = true;
