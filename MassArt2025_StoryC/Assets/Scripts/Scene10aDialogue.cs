...
// AFTER choice 1c
   		...
   		ArtChar1g.SetActive(false);
    		...
    		Char1speech.text = "";
    		Char3name.text = "BULLY";
    		Char3speech.text = "No loser. I'm gonna eviserate you";
}
		...
		ArtChar3a.SetActive(true);
   		ArtChar1a.SetActive(false);
    		ArtChar1d.SetActive(true);
    		Char1name.text = "Lunch Lady";
    		Char1speech.text = "Hey. What's going on out here?";
    		Char3name.text = "";
    		Char3speech.text = "";
}
    		...
    		ArtChar1d.SetActive(false);
    		Char1name.text = "YOU";
    		Char1speech.text = "You don’t need to be a jerk about it.";
    		Char3name.text = "";
    		Char3speech.text = "";
}
    		...
    		ArtChar1b.SetActive(true);
    		Char1name.text = "YOU";
    		Char1speech.text = "[You walk away, victorious, milk in hand.]";
   		Char3name.text = "";
    		Char3speech.text = "";
    		nextButton.SetActive(false);
    		allowSpace = false;
    		NextScene1Button.SetActive(true); //  WIN 
}
